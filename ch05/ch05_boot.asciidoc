...
*	EFI kan makkelijk uitgebreid worden met kleine toepassingen. Denk bijvoorbeeld aan een mediaplayer. Zo zou een laptop kunnen gebruiken als mediaspeler, zelfs zonder dat die ‘echt’ opgestart is.
